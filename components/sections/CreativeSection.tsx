  ...
  return (
    <>
      <section className="min-h-screen flex flex-col  items-center justify-center p-6">
        <p className="md:text-[70px] text-[30px]  font-bold   text-center mt-10  ">
          Unlease your prompt into <span className="  text-violet-500  font-bold">  Reality</span>
        </p>
        <div className=" md:w-[70%]  rotate-[-4deg] mt-10 md:mt-[6.5rem]">
          <MarQuee>
            {rowOneImages.map((i, index) => (
              <Image
                ...
                width={500}
                height={300}
                className="md:m-4 w-[300px] m-2 md:w-[300px] rounded-[20px]"
              />
            ))}
          </MarQuee>
          <MarQuee>
